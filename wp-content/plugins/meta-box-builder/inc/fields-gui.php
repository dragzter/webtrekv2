									...
									<section ng-if="ngModelItem.type">
										<dl class="menu-item-bar menu-item-{{ngModelItem.type}}">
											<dt class="menu-item-handle" ng-click="toggleEdit(ngModelItem, $event)">
												...
												<span class="item-controls">
													...
													<a class="item-edit" href="#"><span class="screen-reader-text"><?php esc_html_e( 'Edit', 'meta-box-builder' ); ?></span></a>
												</span>
											</dt>
										</dl>
										...
										<div class="menu-item-settings" uib-collapse="field.id != active.id">
											...
											<div class="menu-item-actions submitbox">
												...
												<a href="#" role="button" ng-click="unEdit($event)"><?php esc_html_e( 'Cancel', 'meta-box-builder' ); ?></a>
												<a ng-show="ngModelItem.type != 'tab' && ngModelItem.type != 'group'" href="#" role="button" class="mbb-duplicate" ng-click="cloneField(ngModelItem)"><?php esc_html_e( 'Duplicate', 'meta-box-builder' ); ?></a>
											</div>
										</div>
									</section>
