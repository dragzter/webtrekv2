...
<table class="form-table form-table-for">
	...
	<tr class="meta-box-for" ng-show="meta.for == 'post_types'">
		...
		<td>
			<select class="mbb-select2" multiple="multiple" ng-model="meta.post_types" ng-options="pt as pt.name for (key, pt) in post_types track by pt.slug"></select>
		</td>
	</tr>
	 <tr class="meta-box-for" ng-show="meta.for == 'post_types'">
	...
	<tr class="meta-box-for" ng-show="meta.for == 'taxonomies'">
		...
		<td>
			<select class="mbb-select2" multiple="multiple" ng-model="meta.taxonomies" ng-options="taxonomy as taxonomy.name for (key, taxonomy) in taxonomies track by taxonomy.slug"></select>
	...
	<tr class="meta-box-for" ng-show="meta.for == 'settings_pages'">
		...
		<td>
			<select class="mbb-select2" multiple="multiple" ng-model="meta.settings_pages" ng-options="p as p.title for (key, p) in settings_pages track by p.id"></select>
