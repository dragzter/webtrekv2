...
function get_partial_add_testimonial() { 
    ...
    $output .= '<div class="form-group col-md-7"><input type="text" class="form-control" id="review-name" placeholder="Name / Title" name="post_title" required></div>';
    ...
    $output .= '</div></div></div>';
    $output .= '<div class="form-group vanish-on-sub"><textarea type="text" class="form-control" style="resize:none;" rows="6" id="review" placeholder="Review / Comment" name="post_content" required></textarea></div>';
