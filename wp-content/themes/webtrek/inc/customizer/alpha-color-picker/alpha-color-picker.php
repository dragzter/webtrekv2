...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_template_directory_uri() . '/inc/customizer/alpha-color-picker/admin/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_template_directory_uri() . '/inc/customizer/alpha-color-picker/admin/alpha-color-picker.css',
	...
	public function render_content() {
		...
		/**
		 * @edit Moved title and description span outside label so they can be seen without opening the color picker.
		 */
